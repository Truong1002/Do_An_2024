...
import { AttributeType } from '@proxy/shop-ecommerce/product-attributes';
import { ConfirmationService } from 'primeng/api';
import { DialogService } from 'primeng/dynamicdialog';
import { Subject, take, takeUntil } from 'rxjs';
import { NotificationService } from 'src/app/shared/services/notification.service';
import { AttributeDetailComponent } from './attribute-detail.component';
import { ProductAttributeDto, ProductAttributeInListDto } from '@proxy/product-attributes';
import { ProductAttributesService } from '@proxy/catalog/product-attributes';
